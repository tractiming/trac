...
public class ShowcaseViews {
    ...
    public ShowcaseViews addView(ItemViewProperties properties) {
        com.trac.showcaseview.ShowcaseViewBuilder builder = new com.trac.showcaseview.ShowcaseViewBuilder(activity)
     ...
     * @see com.trac.showcaseview.ShowcaseView#animateGesture(float, float, float, float)
     * @see com.trac.showcaseview.ShowcaseViews#addAnimatedGestureToView(int, float, float, float, float, boolean)
     */
    ...
    public void show() {
        ...
        boolean hasShot = activity.getSharedPreferences(com.trac.showcaseview.ShowcaseView.PREFS_SHOWCASE_INTERNAL, Context.MODE_PRIVATE)
                .getBoolean("hasShot" + view.getConfigOptions().showcaseId, false);
        if (hasShot && view.getConfigOptions().shotType == com.trac.showcaseview.ShowcaseView.TYPE_ONE_SHOT) {
    ...
    public static class ItemViewProperties {
        ...
        protected final com.trac.showcaseview.ShowcaseView.ConfigOptions configOptions;
        ...
        public ItemViewProperties(int titleResId, int messageResId, com.trac.showcaseview.ShowcaseView.ConfigOptions configOptions) {
            this(ID_NO_SHOWCASE, titleResId, messageResId, ID_NOT_IN_ACTIONBAR, DEFAULT_SCALE, configOptions);
        }

        public ItemViewProperties(int id, int titleResId, int messageResId, com.trac.showcaseview.ShowcaseView.ConfigOptions configOptions) {
            this(id, titleResId, messageResId, ID_NOT_IN_ACTIONBAR, DEFAULT_SCALE, configOptions);
        }

        public ItemViewProperties(int id, int titleResId, int messageResId, float scale, com.trac.showcaseview.ShowcaseView.ConfigOptions configOptions) {
            this(id, titleResId, messageResId, ID_NOT_IN_ACTIONBAR, scale, configOptions);
        }

        public ItemViewProperties(int id, int titleResId, int messageResId, int itemType, com.trac.showcaseview.ShowcaseView.ConfigOptions configOptions) {
            this(id, titleResId, messageResId, itemType, DEFAULT_SCALE, configOptions);
        }

        public ItemViewProperties(int id, int titleResId, int messageResId, int itemType, float scale, com.trac.showcaseview.ShowcaseView.ConfigOptions configOptions) {
            this.id = id;
