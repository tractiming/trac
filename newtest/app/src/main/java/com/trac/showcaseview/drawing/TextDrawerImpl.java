package com.trac.showcaseview.drawing;
...
import com.trac.showcaseview.utils.ShowcaseAreaCalculator;

/**
 * Draws the text as required by the ShowcaseView
 */
public class TextDrawerImpl implements com.trac.showcaseview.drawing.TextDrawer {
