package com.trac.showcaseview.actionbar.reflection;
...
public abstract class BaseReflector {
    ...
    public static BaseReflector getReflectorForActivity(Activity activity) {
        switch (searchForActivitySuperClass(activity)) {
            case STANDARD:
                return new com.trac.showcaseview.actionbar.reflection.ActionBarReflector(activity);
            case APP_COMPAT:
                return new com.trac.showcaseview.actionbar.reflection.AppCompatReflector(activity);
